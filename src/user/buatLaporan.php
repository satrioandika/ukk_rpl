          ...
          <form action="" method="POST">
            <div class="form-row mb-3">
              <div class="col">
                ...
                <input type="text" class="form-control mb-2" id="tanggal" name="tgl_pengaduan" required value="<?php date_default_timezone_set('Asia/Jakarta'); echo date('Y-m-d (H:i:s)') ?>" readonly>
