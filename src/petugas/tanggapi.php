						...
						<form action="" method="POST">
							<div class="form-row mb-2">
								...
								<div class="col">
									...
									<input type="text" class="form-control" id="exampleInputEmail2" name="tgl_tanggapan"  required value="<?php date_default_timezone_set('Asia/Jakarta'); echo date('Y-m-d (H:i:s)') ?>" readonly>
								</div>
							</div>
							...
							<div class="form-group">
								<select name="id_petugas" id="petugas" class="form-control">
									...
									<option value="1">Firman123</option>
									<option value="2">Hana123</option>
								</select>
							</div>
